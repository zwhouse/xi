...
export class initial1537476907386 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL, "movesJson" text NOT NULL, "isAccepted" boolean NOT NULL, "isGameOver" boolean NOT NULL, "drawProposalCode" character varying NOT NULL, "redPlayerId" integer, "blackPlayerId" integer, "turnPlayerId" integer, "winnerId" integer, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
